...
trait Scheduler {
    fn connect_processor_to_processor<T, S, R, LeftComp, RightComp, OutputComp>(lhs: LeftComp, rhs: RightComp, pipe: (S, R)) -> OutputComp
    where
    ...
    fn connect_ioc_to_component<T, S, R, LeftComp, RightComp, OutputComp>(lhs: LeftComp, rhs: RightComp, pipe: (S, R)) -> OutputComp
    where
